<?php
    ...
    $query = "SELECT actv.ActName, actv.ActDescription, acty.ActTypeName, acty.ActTypeDescrip, catg.CatName, strq.FiscalYrs, strq.ActRole, stud.StuID, stud.StuName, stus.[Status], fact.facName, "
