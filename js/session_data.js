...
function sessionData_staff_faculty_login(name, email, etype, phone, title, depart, division) {  
    sessionStorage.setItem('ss_sf_sat_Name', name);
    sessionStorage.setItem('ss_sf_sat_Email', email);
    sessionStorage.setItem('ss_sf_sat_EType', etype);
    sessionStorage.setItem('ss_sf_sat_Phone', phone);
    sessionStorage.setItem('ss_sf_sat_Title', title);
    sessionStorage.setItem('ss_sf_sat_Depart', depart);
